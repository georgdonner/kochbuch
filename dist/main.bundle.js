...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_routing_module__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__recipes_recipes_module__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__svgicons_svg_icon_svg_icon_component__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_form_recipe_form_component__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_list_recipe_list_component__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recipe_edit_recipe_edit_component__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__recipe_details_recipe_details_component__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_form_recipe_form_component__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__recipe_list_recipe_list_component__ = __webpack_require__(67);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__recipe_service__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__recipes_routing_module__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__recipe_edit_recipe_edit_component__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__calc_servings_pipe__ = __webpack_require__(212);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__filter_recipes_pipe__ = __webpack_require__(213);
...
RecipesModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* NgModule */])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_9__calc_servings_pipe__["a" /* CalcServingsPipe */],
            __WEBPACK_IMPORTED_MODULE_10__filter_recipes_pipe__["a" /* FilterRecipesPipe */]
        ],
...
// module
exports.push([module.i, ".icon-spoon-knife {\r\n    fill: #222;\r\n    position: absolute;\r\n    top: 50px;\r\n    right: 50px;\r\n    width: 20px;\r\n    height: 20px;\r\n}\r\n\r\n.icon-chevron-left {\r\n    fill: #222;\r\n    position: absolute;\r\n    top: 50px;\r\n    left: 20px;\r\n    width: 2em;\r\n    height: 2em;\r\n}\r\n\r\n.badge.cook-badge {\r\n    background-color: #222;\r\n    position: absolute;\r\n    top: 50px;\r\n    right: 20px;\r\n}\r\n\r\n@media only screen and (max-width: 767px) {\r\n    .icon-spoon-knife {\r\n        top: 10px;\r\n    }\r\n\r\n    .icon-chevron-left {\r\n        display: none;\r\n    }\r\n\r\n    .badge.cook-badge {\r\n        top: 10px;\r\n    }\r\n}", ""]);
...
module.exports = "<div *ngIf=\"recipe\" class=\"container\">\r\n  <form #recipeForm=\"ngForm\">\r\n    <h1>{{ recipe.title }}</h1>\r\n    <div class=\"form-group\">\r\n      <label for=\"title\">Titel</label>\r\n      <input type=\"text\" [(ngModel)]=\"recipe.title\" name=\"title\" class=\"form-control\" id=\"title\" required #title=\"ngModel\">\r\n    </div>\r\n    <div [hidden]=\"title.valid || title.pristine\"\r\n          class=\"alert alert-danger\">\r\n      Das Rezept muss einen Titel haben\r\n    </div>\r\n    <label>Titelbild</label>\r\n    <img *ngIf=\"recipe.heroImage\" class=\"img-responsive\" src=\"{{recipe.heroImage}}\" alt=\"{{recipe.title}}\">\r\n    <button type=\"button\" class=\"btn btn-default\" (click)=showHeroPicker()>Neues Bild</button>\r\n    <div class=\"form-inline\">\r\n      <div class=\"form-group\">\r\n        <input type=\"number\" [(ngModel)]=\"recipe.servings\" name=\"servings\" id=\"servings\" class=\"form-control\"><span> Portionen</span>\r\n      </div>\r\n      <div class=\"form-group\">\r\n        <label for=\"duration\">Dauer</label>\r\n        <input type=\"number\" [(ngModel)]=\"recipe.duration\" name=\"duration\" id=\"duration\" class=\"form-control\"><span> Minuten</span>\r\n      </div>\r\n      <div class=\"form-group\">\r\n        <label for=\"difficulty\">Schwierigkeit</label>\r\n        <input type=\"number\" [(ngModel)]=\"recipe.difficulty\" name=\"difficulty\" id=\"difficulty\" class=\"form-control\">\r\n      </div>\r\n    </div>\r\n    <div class=\"form-group\">\r\n      <p>Zutaten: </p>\r\n      <div *ngFor=\"let ingr of ingredients; let i = index\">\r\n        {{ ingr.name }} <span *ngIf=\"ingr.hint!=''\">({{ ingr.hint }})</span>\r\n        <input *ngIf=\"ingredientAdded\" type=\"button\" value=\"X\" class=\"btn btn-danger btn-xs\" (click)=removeIngredient(ingr)>\r\n      </div>\r\n      <input type=\"text\" [(ngModel)]=\"newIngredient.name\" name=\"name\" class=\"form-control\" id=\"name\" \r\n            (keyup.enter)=\"addIngredient()\" placeholder=\"Enter drücken zum Hinzufügen\">\r\n      <label for=\"hint\">Hinweis</label>\r\n      <input type=\"text\" [(ngModel)]=\"newIngredient.hint\" name=\"hint\" class=\"form-control\" id=\"hint\" \r\n            (keyup.enter)=\"addIngredient()\" placeholder=\"z.B. (Am besten frisch) - Klammern werden automatisch gesetzt\">\r\n    </div>\r\n    <div class=\"form-group\">\r\n      <label for=\"description\">Beschreibung</label>\r\n      <input type=\"text\" [(ngModel)]=\"recipe.description\" name=\"description\" class=\"form-control\" id=\"description\" required #description=\"ngModel\">\r\n    </div>\r\n    <div [hidden]=\"description.valid || description.pristine\"\r\n          class=\"alert alert-danger\">\r\n      <p *ngIf=\"recipe.descrImage\">Bitte gib dem Rezept noch eine kurze Beschreibung</p>\r\n      <p *ngIf=\"!recipe.descrImage\">Das Rezept braucht eine Beschreibung, vor allem ohne Bild!</p>\r\n    </div>\r\n    <img *ngIf=\"recipe.descrImage\" class=\"img-responsive\" src=\"{{recipe.descrImage}}\" alt=\"Recipe description\">\r\n    <button type=\"button\" class=\"btn btn-default\" (click)=showDescPicker()>Neues Bild</button>\r\n    <div class=\"form-group\">\r\n      <label for=\"category\">Kategorien: </label>\r\n      <span *ngFor=\"let ctg of recipe.categories\">\r\n        {{ ctg }}\r\n        <button type=\"button\" class=\"close no-float\" (click)=\"removeCategory(ctg)\">x</button>\r\n      </span>\r\n      <input #category type=\"text\" name=\"category\" class=\"form-control\" id=\"category\" \r\n            (keyup.enter)=\"addCategory(category.value); category.value=''\" placeholder=\"Enter drücken zum Hinzufügen\">\r\n    </div>\r\n    <button type=\"button\" (click)=\"save(); gotoRecipe(recipe)\" class=\"btn btn-success\" [disabled]=\"!recipeForm.form.valid\">Speichern</button>\r\n  </form>\r\n</div>\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_switchMap__ = __webpack_require__(80);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_switchMap___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_switchMap__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ingredient__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_service__ = __webpack_require__(18);
...
var RecipeEditComponent = (function () {
    function RecipeEditComponent(recipeService, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.newIngredient = new __WEBPACK_IMPORTED_MODULE_3__ingredient__["a" /* Ingredient */]('', '');
    }
    ...
    RecipeEditComponent.prototype.showHeroPicker = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        client = filestack.init('AwD48ceQaWtGBs9plMog7z');
...
RecipeEditComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__recipe_service__["a" /* RecipeService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__recipe_service__["a" /* RecipeService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _c || Object])
], RecipeEditComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__recipe__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ingredient__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__recipe_service__ = __webpack_require__(18);
...
var RecipeFormComponent = (function () {
    function RecipeFormComponent(recipeService, router) {
        this.recipeService = recipeService;
        this.router = router;
        this.ingredients = [new __WEBPACK_IMPORTED_MODULE_3__ingredient__["a" /* Ingredient */]('', '')];
        this.newIngredient = new __WEBPACK_IMPORTED_MODULE_3__ingredient__["a" /* Ingredient */]('', '');
        this.categories = [];
        this.model = new __WEBPACK_IMPORTED_MODULE_2__recipe__["a" /* Recipe */]('', 2, 0, 0, 0, this.ingredients, '');
