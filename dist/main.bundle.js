...
module.exports = "<ng-template #content let-c=\"close\" let-d=\"dismiss\">\r\n  <div class=\"modal-header\">\r\n    <h4 class=\"modal-title\">Umrechner</h4>\r\n    <button type=\"button\" class=\"close\" (click)=\"d('Cross click')\">\r\n      <span aria-hidden=\"true\">&times;</span>\r\n    </button>\r\n  </div>\r\n  <div class=\"modal-body\">\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"ml\" [ngModel]=\"quantity\" (ngModelChange)=\"quantity=$event\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>ml</strong> (Milliliter)</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"l\" [ngModel]=\"quantity/1000\" (ngModelChange)=\"quantity=$event*1000\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>l</strong> (Liter)</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"tl\" [ngModel]=\"quantity/5\" (ngModelChange)=\"quantity=$event*5\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>TL</strong> (Teelöffel)</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"el\" [ngModel]=\"quantity/15\" (ngModelChange)=\"quantity=$event*15\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>EL</strong> (Esslöffel)</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"kleine-tasse\" [ngModel]=\"quantity/125\" (ngModelChange)=\"quantity=$event*125\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>kleine</strong> Tasse</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"grosse-tasse\" [ngModel]=\"quantity/200\" (ngModelChange)=\"quantity=$event*200\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>große</strong> Tasse</span>\r\n    <input type=\"number\" class=\"form-control col-6 col-sm-8 d-inline-block\" name=\"cup\" [ngModel]=\"quantity/250\" (ngModelChange)=\"quantity=$event*250\">\r\n    <span class=\"pl-1 col-6 col-sm-4\"><strong>Cup</strong> (amerik.)</span>\r\n  </div>\r\n</ng-template>\r\n\r\n<button type=\"button\" class=\"btn btn-secondary\" (click)=\"open(content)\">\r\n  <svg class=\"icon icon-refresh\"><use inlineHref=\"#icon-refresh\"></use></svg>\r\n  <span class=\"pl-1\">Umrechner</span>\r\n</button>\r\n"
